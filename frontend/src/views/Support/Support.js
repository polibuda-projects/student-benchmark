    ...
    <Page className={style.fullPage} titlebar={false}>
      <ContainerBox className={style.container} width={'100%'}>
        ...
        <form method="post" action="#" className={style.form}>
          <Input useRef={email} required={true} type={'email'} name={'emailSupport'} placeholder={'Email'} className={style.formElement} />
          <Input useRef={title} required={true} type={'text'} name={'titleSupport'} placeholder={'Title'} className={style.formElement} />
